...
public class UseDLL
{
    ...
    public void InitialStep()
    {
        ...
        CSharpLibrary.CSharpLibrary.lammps_command(deref1, "variable xx equal 3");
        CSharpLibrary.CSharpLibrary.lammps_command(deref1, "variable yy equal 3");
        CSharpLibrary.CSharpLibrary.lammps_command(deref1, "variable zz equal 3");
