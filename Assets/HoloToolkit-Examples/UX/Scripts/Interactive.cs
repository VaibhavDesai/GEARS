    ...
    public class Interactive : MonoBehaviour, IInputClickHandler, IFocusable, IInputHandler
    {
        ...
        public virtual void OnInputClicked(InputClickedEventData eventData)
        {
            ...
            switch (this.gameObject.name)
            {
                ...
                case ("demo2"):
                    StartCoroutine(loadScene("testing/Scenes/NanoCarbon"));

                    break;
                case ("demo1"):

                    StartCoroutine(loadScene("testing/Scenes/RDX"));
                    break;

                case ("demo3"):
                    StartCoroutine(loadScene("testing/Scenes/mos2-scene1"));

                    break;
                case ("demo4"):
                    StartCoroutine(loadScene("testing/Scenes/Demo4(LJ)"));

                    break;

                case ("demo5"):
                    StartCoroutine(loadScene("testing/Scenes/Graphene"));

                    break;

                case ("selectFile"):
                    PlayerPrefs.SetString("file_path", "1");
                    StartCoroutine(loadScene("testing/Scenes/NanoCarbon"));
                    break;
                ...
                case ("ShareLJ"):
                    PlayerPrefs.SetString("file_path", "1");
                    StartCoroutine(loadScene("testing/Scenes/Demo4(LJ)_client"));
                    break;
                case ("LAMMPS"):
                    PlayerPrefs.SetString("file_path", "1");
                    StartCoroutine(loadScene("testing/Scenes/RealTime"));
                    break;

                case ("Next"):
                    StartCoroutine(loadScene("testing/Scenes/mos2-scene2"));
